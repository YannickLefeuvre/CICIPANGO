...
type ApplicationUserFormGroupContent = {
  ...
  photoprincipal: FormControl<IApplicationUser['photoprincipal']>;
  photoprincipalContentType: FormControl<IApplicationUser['photoprincipalContentType']>;
};
...
export class ApplicationUserFormService {
  createApplicationUserFormGroup(applicationUser: ApplicationUserFormGroupInput = { id: null }): ApplicationUserFormGroup {
    ...
    return new FormGroup<ApplicationUserFormGroupContent>({
      ...
      photoprincipal: new FormControl(applicationUserRawValue.photoprincipal),
      photoprincipalContentType: new FormControl(applicationUserRawValue.photoprincipalContentType),
    });
  }
