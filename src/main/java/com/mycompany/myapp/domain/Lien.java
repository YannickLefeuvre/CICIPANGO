...
public class Lien implements Serializable {
    ...
    public Contenant getVilleOrigine() {
        return this.villeOrigine;
    }

    public void setVilleOrigine(Contenant contenant) {
        this.villeOrigine = contenant;
    }

    public Lien villeOrigine(Contenant contenant) {
        this.setVilleOrigine(contenant);
        return this;
    }

    public Contenant getVilleCible() {
        return this.villeCible;
    }

    public void setVilleCible(Contenant contenant) {
        this.villeCible = contenant;
    }
